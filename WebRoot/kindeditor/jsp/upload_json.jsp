...
String savePath = request.getSession().getServletContext().getRealPath("/") + "upload-files/editorImage/";   
//文件保存目录URL /kindeditor/attached/  
String saveUrl = request.getContextPath() + "/upload-files/editorImage/";   
//定义允许上传的文件扩展名   
//定义允许上传的文件扩展名   
...
for(int i=0;i<wrapper.getFileNames("imgFile").length;i++) {
	System.out.println(wrapper.getFileNames("imgFile")[i]);
}
