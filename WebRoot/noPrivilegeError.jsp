...
<TABLE height=382 cellSpacing=0 cellPadding=0 width=470 align=center border=0>
  ...
  <TR>
    <TD vAlign=top 
    background="${pageContext.request.contextPath}/style/common/images/error/bg.gif"><BR>
            ...
            align=center>
              ...
              <TR>
                <TD align=middle height=14><SPAN class=style6><FONT 
                  color=#ff0000 
          size=6>ACCESS DENIED!</FONT></SPAN></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD>&nbsp;</TD>
          <TD>
            <DIV align=center>
            ...
            border=0>
              <TBODY>
              <TR>
                <TD>您的权限不足以支持您此项操作！</TD></TR>
              <TR>
                <TD>
                  <LI>赶快访问<A href="forum.html"><FONT 
                  color=#990000>论坛首页</FONT></A></LI></TD></TR>
              <TR>
                <TD>
                  <LI><FONT 
                  color=#990000>请尝试联系管理员</FONT></A></LI></TD></TR>
              <TR>
                <TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
        ...
        <TR>
          <TD width="38%">&nbsp;</TD>
          <TD width="17%">
            <DIV align=right><A href="forum.html"><IMG height=38 
            src="${pageContext.request.contextPath}/style/common/images/error/jt.gif" width=56 
            border=0></A></DIV></TD>
          <TD width="45%">
            <DIV align=center><A href="forum.html"><FONT 
